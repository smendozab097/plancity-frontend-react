...
const Login = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] w-full bg-slate-50 flex items-center justify-center py-12 px-4 relative overflow-hidden">
      {/* Luz ambiental sutil */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-blue-100/60 blur-[140px] rounded-full pointer-events-none"></div>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-1.5">
            <label htmlFor="login-email-input" className="text-xs font-bold uppercase tracking-wider text-slate-700">
              Correo electrónico
            </label>
            <input
          ...
          {/* Campo Contraseña */}
          <div className="space-y-1.5">
            <label htmlFor="login-password-input" className="text-xs font-bold uppercase tracking-wider text-slate-700">
              Contraseña
            </label>
            <input
